...
<fmt:message bundle="${loc}" key="local.user_page.declaration_submission_mes" var="declaration_submission_mes"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    <h1>${declaration_submission_mes} <c:out value="${sessionScope.new_declaration_number}"/>.</h1>
		  </div>
          <div id="rightcol">
