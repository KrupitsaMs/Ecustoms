...
<title>Choose Declaration to show</title>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    <h2>${a_decl_number_choose}</h2>
			<form action="Controller" method="post">
			    <input id="decl_number" type="text" name="decl_number" value=""/>
				<br/>
				<input type="hidden" name="command" value="a_show_declaration" />
		        <input id="button" type="submit" value="${a_show_declaration}" />
	         </form>
		  </div>
          <div id="rightcol">
