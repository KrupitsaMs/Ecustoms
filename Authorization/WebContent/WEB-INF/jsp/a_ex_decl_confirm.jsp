...
<title>Declaration confirmation</title>
...
<fmt:message bundle="${loc}" key="local.content.ex_decl_confirmation" var="ex_decl_confirmation"/>
    ...
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    ...
		    <h1> Status: ${ex_decl_confirmation}</h1>
		  </div>
          <div id="rightcol">
