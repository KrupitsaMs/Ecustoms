...
<title>Declaration proccessing</title>
...
<fmt:message bundle="${loc}" key="local.content.decl_confirmation_processing" var="decl_confirmation_processing"/>
    ...
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    ...
		    <h1> Status: ${decl_confirmation_processing}</h1>
		  </div>
          <div id="rightcol">
