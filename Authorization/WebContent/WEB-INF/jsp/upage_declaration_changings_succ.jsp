...
<title>Changing Submission successful</title>
...
<fmt:message bundle="${loc}" key="local.user_page.declaration_changes_submission_mes" var="declaration_changes_submission_mes"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    <h1>${declaration_changes_submission_mes}</h1>
		  </div>
          <div id="rightcol">
