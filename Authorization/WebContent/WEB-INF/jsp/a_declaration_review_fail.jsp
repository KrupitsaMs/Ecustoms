...
<title>Declaration review failes</title>
<fmt:setLocale value="${sessionScope.command}"/>
<fmt:setBundle basename="resources.locale" var="loc" />
<fmt:message bundle="${loc}" key="local.content.a_declaration_review_fail" var="a_declaration_review_fail"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    <h1>${a_declaration_review_fail}</h1>
		  </div>
          <div id="rightcol">
