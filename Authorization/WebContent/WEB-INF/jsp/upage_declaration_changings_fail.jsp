...
<title>Changing Submission failed</title>
...
<fmt:message bundle="${loc}" key="local.user_page.declaration_changes_submission_fail" var="declaration_changes_submission_fail"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		    <h1>${declaration_changes_submission_fail}</h1>
		  </div>
          <div id="rightcol">
