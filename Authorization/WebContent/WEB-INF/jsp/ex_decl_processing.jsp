...
<title>Export declaration processing</title>
...
<fmt:message bundle="${loc}" key="local.content.ex_decl_confirmation_processing" var="ex_decl_confirmation_processing"/>
    ...
    <div id="container2">
        <div id="container1">
		  ...
		  <jsp:useBean id="declaration" class="by.epam.authorization.entity.Declaration" type="java.lang.Object" scope="request"/>
		    ...
		    <h1> Status: ${ex_decl_confirmation_processing}</h1>
		  </div>
          <div id="rightcol">
		  </div>
        </div>
