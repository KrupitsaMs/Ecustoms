...
<title>Declaration changings</title>
...
<fmt:message bundle="${loc}" key="local.content.new_declaration_message" var="new_declaration_message"/>
...
<fmt:message bundle="${loc}" key="local.content.table_colomn_header1" var="table_colomn_header1"/>
<fmt:message bundle="${loc}" key="local.content.table_colomn_header2" var="table_colomn_header2"/>
<fmt:message bundle="${loc}" key="local.content.new_goods_message" var="new_goods_message"/>
<fmt:message bundle="${loc}" key="local.content.create_declaration_changes" var="create_declaration_changes"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		  <form action="Controller" method="post">
	          <input type="hidden" name="command" value="create_declaration_changes" />
			    <table>
			      <caption><h2>${new_declaration_message}</h2></caption>
				    <tr>
                      <th>${table_colomn_header1}</th>
                      <th>${table_colomn_header2}</th>
                    </tr>
					<tr>
					  <td><input id="good" type="text" name="declaration_type" value=""/></td>
					  <td><input id="good" type="text" name="trade_country" value=""/></td>
					</tr>
			    </table>
				<br/>
				<table>
				...
				<input id="button" type="submit" value="${create_declaration_changes}"/>
		  </form>
		  </div>
          <div id="rightcol">
