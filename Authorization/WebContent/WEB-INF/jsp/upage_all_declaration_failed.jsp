...
<title>Declarations not founed</title>
...
<fmt:message bundle="${loc}" key="local.content.all_declaration_failed" var="all_declaration_failed"/>
<fmt:message bundle="${loc}" key="local.leftcol.show_all_declarations" var="show_all_declarations"/>
