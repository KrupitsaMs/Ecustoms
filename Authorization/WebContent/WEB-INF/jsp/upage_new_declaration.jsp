...
<title>Submission of a new Declaration</title>
...
<fmt:message bundle="${loc}" key="local.content.create_declaration" var="create_declaration"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		  <form action="Controller" method="post">
	          <input type="hidden" name="command" value="create_new_declaration" />
			    <table>
				...
				<input id="button" type="submit" value="${create_declaration}"/>
		  </form>
		  </div>
          <div id="rightcol">
