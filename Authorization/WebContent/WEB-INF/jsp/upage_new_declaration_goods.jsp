...
<title>Add good to new declaration</title>
...
<fmt:message bundle="${loc}" key="local.content.add_new_good" var="add_new_good"/>
  ...
  <div id="container3">
    <div id="container2">
        <div id="container1">
          ...
          <div id="content">
		  <form action="Controller" method="post">
	          <input type="hidden" name="command" value="add_new_good" />
				<table>
				...
				<input id="button" type="submit" value="${add_new_good}"/>
		  </form>
		  <br/>
		  <form action="Controller" method="post">
		    <input type="hidden" name="command" value="submit_new_declaration" />
		    <input id="button" type="submit" value="${submit_declaration}"/>
		  </form>
		  </div>
          <div id="rightcol">
